...
class LCD : public LiquidCrystal_I2C
{
  public:
    ...
    void top_bar(bool card); // print the battery percentage in the top right corner
    ...
    bool gpslock_screen(int sats,int invalid_sats); // top row for gps search screen
